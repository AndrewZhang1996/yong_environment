...
public interface SysUserMapper extends BaseMapper<SysUser> {
	...
	public List<SysUser> getUsersByNames(@Param("usernames") List<String> usernames);

	public List<SysUser> getUsersByStatusAndOrg(@Param("status") Integer status, @Param("orgCode") String orgCode);
